...
def cmdGiven():
    ...
    def decider():
        global studyList, breakList, SevendayStudyList, SevendayBreakList, breakHoursList, studyHoursList, babaBreakSheepList, change_inStudyList, change_inSevenStudyList, change_inbreakHourList, change_instudyHourList
        current_time = localtime()
        if cmd == '0':
            pass

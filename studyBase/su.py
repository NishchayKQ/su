...
def cmdGiven():
    ...
    def decider():
        ...
        if cmd == "0":
            ...
            print(
                "time difference between\033[38;2;0;255;255m given time and current time\033[0m")
            ...
            print(
                f"from {h1}:{m1} to {h2}:{m2} \033[38;2;255;255;0m{round(temp,2)} hrs\033[0m or\033[38;2;255;255;0m {round(temp*60)} mins\033[0m have passed")
            cmdGiven()
